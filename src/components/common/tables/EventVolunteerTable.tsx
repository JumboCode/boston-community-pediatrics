  ...
  return (
    <div className="max-w-[1000px] flex">
      <div className="w-[750px] relative p-[20px] border-b border-r border-gray-300">
        ...
        <div className="text-bcp-blue text-[14px] font-normal font-avenir">
          <p className="text-[14px]">
            {new Date(startTime).toLocaleDateString(undefined, { month: "long", day: "numeric" })}
            {", "}
      ...
      <div className="border-b border-gray-300 w-[250px] p-[20px]">
        ...
        {error && (
          <p className="text-red-500 text-right mt-2 text-sm">Failed to load volunteers</p>
        )}
                  ...
                  <div className="flex mt-[4px]">
                    <div className="flex flex-col flex-1" style={{ marginRight: 8 }}>
                      {volunteer.guests.map((guest) => (
                        <div key={guest.id} className="flex items-center justify-end" style={{ height: 36 }}>
                          <span className="text-bcp-blue text-[15px] font-normal font-avenir">
                    ...
                    <div className="flex flex-col" style={{ width: 28, marginTop: -8 }}>
                      {volunteer.guests.map((guest, gIdx) => {
                        ...
                        return (
                          <svg key={guest.id} width="28" height="36" viewBox="0 0 28 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line x1="14" y1="0" x2="14" y2={isLast ? "18" : "36"} stroke="#D9D9D9" strokeWidth="3" strokeLinecap="round" />
                            <path d="M14 18 Q14 28 2 28" stroke="#D9D9D9" strokeWidth="3" fill="none" strokeLinecap="round" />
                          </svg>
                        );
                      })}
                    </div>
